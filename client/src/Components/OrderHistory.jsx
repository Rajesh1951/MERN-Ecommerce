...
function OrderHistory() {
  ...
  function handleStars(n) {
    ...
    for (let i = 0; i < 5; i++) {
      if (s >= 1) {
        stars.push(<li className='inline'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} className="w-5 h-5 inline -mt-1">
        ...
        stars.push(<li className='inline'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke='gold' className="w-5 h-5 inline -mt-1">
                          ...
                          return <li key={index} className="flex py-6">
                            ...
                            <div className="ml-4 flex flex-1 flex-col">
                              ...
                              <div className="flex flex-1 items-end justify-between text-sm">
                                <p className="text-gray-500">Ratings: <span className='font-bold'>{order.rating}</span>
                                  <ul className='inline'>
                                    {handleStars(order.rating).map(e => e)}
                                  </ul>
                                </p>
                              </div>
                            </div>
